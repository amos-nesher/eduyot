...
export const SALONIKY_MONSTIRELIS:string = `כאן יהיה תיאור של בית הכנסת מונסטירליס`;

export const SALONIKY_NEW_CEMETRY:string = `כאן יהיה תיאור של בית העלמין החדש`;

export const SALONIKY_WHITE_TOWER:string = `כאן יהיה תיאור של המגדל הלבן`;
